...
public class DummyPhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.floating_otp);
...
//        mSignedInViews = findViewById(R.id.signedInButtons);
       ...
       // mDetailText = findViewById(R.id.detail);
        ...
        mStartButton = findViewById(R.id.buttonSendOtp);
...
//                        mVerificationField);
//                CategoryFragmentPagerAdapter pagerAdapter = new CategoryFragmentPagerAdapter(getSupportFragmentManager(),this);
//
//                viewPager.setAdapter(pagerAdapter);
                Toast.makeText(getApplicationContext(), "On Success",Toast.LENGTH_LONG);
            ...
            case STATE_SIGNIN_SUCCESS:
               // Toast.makeText(this, "On Success",Toast.LENGTH_LONG);
               // Log.v("Sign in Success","Without User");
